...
Words should be separated by only spaces and not hyphens. No need to validate parameters, they will always be in
the range [0, 99]. Make sure that the returned String has no leading of trailing spaces. Good luck!
 */

public class NameThatNumber {
    private String nameThatNumber(int number) {
        String name = "";
